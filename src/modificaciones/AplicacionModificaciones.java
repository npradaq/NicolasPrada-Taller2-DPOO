...
public class AplicacionModificaciones {
    ...
    public void cargarInformacion()  throws FileNotFoundException, IOException, NumberFormatException, CloneNotSupportedException {
        ...
        File archivoIngredientes = new File("data/Modificaciones/ingredientesModificaciones.txt");
        File archivoMenu = new File("data/Modificaciones/menuModificaciones.txt");
        File archivoCombos = new File("data/Modificaciones/combosModificaciones.txt");
        File archivoBebidas = new File("data/Modificaciones/bebidasModificaciones.txt");
